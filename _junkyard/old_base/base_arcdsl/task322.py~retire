...
def Q(a,b):
	...
	return frozenset()
def PU(A,B):return Q(A,(A[0]+42*B[0],A[1]+42*B[1]))
...
def p(I):I=tuple(map(tuple,I));A=W(I,True,False,True);B=PX(PU,(1,0));C=G(B,H);D=PY(M,PS,C);E=R(D,A);F=PE(I,E);return[*map(list,F)]