# best: 81(ox jam, 4atj sisyphus luke Seek mukundan, jailctf merger, xsot ovs att joking mewheni) / others: 86(JRKX), 86(kabutack), 86(jonas ryno kg583 kabutack), 86(jonas ryno kg583), 86(JRK)
