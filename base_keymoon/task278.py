# best: 118(4atj sisyphus luke Seek mukundan) / others: 119(ox jam), 119(xsot ovs att joking mewheni), 120(jailctf merger), 121(intgrah jimboko awu macaque sammyuri), 213(MasukenSamba)
# ======================================================= 118 ========================================================
...
# port re;p=lambda g,c=-11:g*c or p(eval(re.sub(r"0(?=(.{,6}.{%s}|, )2.{%s}2)"%(a:=len(g)*3-2,a+3),"3",str([*zip(*g)][::1|c%3%-2]))),c+1)
import re;p=lambda g,c=-11:g*c or p(eval(re.sub(r"0(?=.{,3}(.{%s})?2.{%s}2)"%(a:=len(g)*3-2,a+3),"3",str([*zip(*g)][::1|c%3%-2]))),c+1)
