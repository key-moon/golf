# best: 118(jacekw Potatoman nauti natte, 4atj sisyphus luke Seek mukundan, import itertools, intgrah jimboko awu macaque sammyuri) / others: 119(jailctf merger), 119(ox jam), 147(THUNDER THUNDER), 204(JRKKX), 209(ShadowPrompt Labs)
# ======================================================= 118 ========================================================
