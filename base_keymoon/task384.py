# best: 62(ox jam, 4atj sisyphus luke Seek mukundan, jailctf merger, xsot ovs att joking mewheni) / others: 64(intgrah jimboko awu macaque sammyuri), 66(2F), 66(biz), 70(natte), 72(HETHAT)
