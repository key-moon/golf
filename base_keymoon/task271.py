# best: 86(ox jam) / others: 92(jailctf merger), 94(jacekw Potatoman nauti natte), 94(import itertools), 96(Code Golf International), 96(4atj sisyphus luke Seek mukundan)
# 9x9グリッド 背景: 0
