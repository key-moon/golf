# best: 54(MasukenSamba, jailctf merger, ox jam) / others: 56(Code Golf International), 56(4atj sisyphus luke Seek mukundan), 56(HETHAT), 56(intgrah jimboko awu macaque sammyuri), 57(ShadowPrompt Labs)
