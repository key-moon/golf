# best: 63(jacekw Potatoman nauti natte, import itertools) / others: 64(ox jam), 65(jailctf merger), 65(4atj sisyphus luke Seek mukundan), 65(Yuchen20), 65(Code Golf International)
