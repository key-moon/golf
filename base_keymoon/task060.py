# best: 48(cubbus, 4atj sisyphus luke Seek mukundan, natte, jailctf merger, ox jam, intgrah jimboko awu macaque sammyuri) / others: 50(jonas ryno kg583 kabutack), 50(jacekwl Potatoman nauti), 50(JRK), 50(JRKX), 50(jonas ryno kg583)
# def p(g):
#  *l,=zip(*g)
