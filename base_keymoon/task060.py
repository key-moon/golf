# best: 47(jailctf merger, intgrah jimboko awu macaque sammyuri) / others: 48(cubbus), 48(jacekw Potatoman nauti natte), 48(Code Golf International), 48(4atj sisyphus luke Seek mukundan), 48(natte)
# def p(g):
#  *l,=zip(*g)
