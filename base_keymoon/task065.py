# best: 91(ox jam) / others: 100(Code Golf International), 100(4atj sisyphus luke Seek mukundan), 100(jailctf merger), 107(ï¾ï½²ï½½ï½¹ï¾ï½»ï¾ï¾ï¾II), 107(cg-klogw-sekken)
# =========================================== 91 ==========================================
# 転置再帰だと 3x3の判定ができない
