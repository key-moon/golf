# best: 55(jacekw Potatoman nauti natte, import itertools, intgrah jimboko awu macaque sammyuri) / others: 58(jailctf merger), 68(Code Golf International), 68(4atj sisyphus luke Seek mukundan), 68(ox jam), 68(biz)
