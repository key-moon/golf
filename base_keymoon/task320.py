# best: 68(4atj sisyphus luke Seek mukundan, jailctf merger, intgrah jimboko awu macaque sammyuri) / others: 70(kabutack), 72(xsot ovs att joking mewheni), 76(MasukenSamba), 81(2F), 81(biz)
# 多分70までは縮むはず
