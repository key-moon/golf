# best: 66(intgrah jimboko awu macaque sammyuri) / others: 68(Code Golf International), 68(4atj sisyphus luke Seek mukundan), 68(import itertools), 68(jailctf merger), 69(ï¾ï½²ï½½ï½¹ï¾ï½»ï¾ï¾ï¾II)
# 多分70までは縮むはず
