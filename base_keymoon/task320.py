# best: 68(4atj sisyphus luke Seek mukundan, jailctf merger, intgrah jimboko awu macaque sammyuri) / others: 70(JRKX), 70(ShadowPrompt Labs), 70(kabutack), 70(JRKXK), 70(JRKKX)
# 多分70までは縮むはず
