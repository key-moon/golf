# best: 50(4atj sisyphus luke Seek mukundan, jailctf merger, ox jam, intgrah jimboko awu macaque sammyuri) / others: 54(jacekw Potatoman nauti natte), 54(ShadowPrompt Labs), 54(HETHAT), 54(natte), 54(kambarakun)
