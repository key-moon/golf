# best: 50(ox jam, 4atj sisyphus luke Seek mukundan, jailctf merger, intgrah jimboko awu macaque sammyuri, xsot ovs att joking mewheni) / others: 54(duckyluuk), 54(Yuchen20), 54(HETHAT), 56(JRKX), 56(kabutack)
