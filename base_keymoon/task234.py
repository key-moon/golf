# best: 118(jailctf merger) / others: 120(4atj sisyphus luke Seek mukundan), 120(ox jam), 121(intgrah jimboko awu macaque sammyuri), 129(cubbus), 137(jacekw Potatoman nauti natte)
# ======================================================= 118 ========================================================
# TODO: gcdシフト再帰
