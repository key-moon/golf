# best: 118(jailctf merger) / others: 120(ox jam), 120(4atj sisyphus luke Seek mukundan), 120(xsot ovs att joking mewheni), 136(intgrah jimboko awu macaque sammyuri), 137(natte)
# ======================================================= 118 ========================================================
# TODO: gcdシフト再帰
