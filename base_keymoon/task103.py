# best: 29(natte, ox jam, cubbus, duckyluuk, 4atj sisyphus luke Seek mukundan, JRKX, jacekw Potatoman nauti, Rafael Pooja, MasukenSamba, HashPanda, 2F, biz, jailctf merger, intgrah jimboko awu macaque sammyuri, HashPanda Pooja, jonas ryno kg583 kabutack, Yuchen20, HETHAT, cg-klogw, jacekwl Potatoman nauti, blob2822, jonas ryno kg583, JRK) / others: 30(kabutack), 31(dbdr), 31(cg), 31(jacekwl), 38(kdmitrie)
# ============ 29 ===========
# 縦横線対称([[7]]) or 対称性0([[1]])
