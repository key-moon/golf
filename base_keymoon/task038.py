# best: 51(ox jam, 4atj sisyphus luke Seek mukundan, 2F, biz, jailctf merger, intgrah jimboko awu macaque sammyuri, xsot ovs att joking mewheni) / others: 52(natte), 52(Potatoman), 52(duckyluuk), 52(JRKX), 52(jacekw Potatoman nauti)
# 残念ながらsum(g,[])するとだめ
