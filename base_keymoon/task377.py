# best: 55(jailctf merger, 4atj sisyphus luke Seek mukundan, Code Golf International) / others: 57(ox jam), 57(intgrah jimboko awu macaque sammyuri), 63(import itertools), 65(cubbus), 68(ShadowPrompt Labs)
