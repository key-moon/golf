# best: 89(jailctf merger, 4atj sisyphus luke Seek mukundan, Code Golf International) / others: 93(ox jam), 102(intgrah jimboko awu macaque sammyuri), 112(2F), 112(biz), 116(import itertools)
