# best: 325(jacekw Potatoman nauti natte, ox jam, intgrah jimboko awu macaque sammyuri) / others: 344(jailctf merger), 367(JRKKX), 369(natte), 373(cg-klogw-sekken), 373(cg-klogw)
