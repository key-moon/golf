# best: 325(ox jam, intgrah jimboko awu macaque sammyuri) / others: 344(jailctf merger), 369(jacekw Potatoman nauti natte), 369(natte), 373(cg-klogw-sekken), 373(cg-klogw)
