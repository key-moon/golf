# best: 78(jailctf merger) / others: 81(Code Golf International), 81(4atj sisyphus luke Seek mukundan), 82(ox jam), 101(jacekw Potatoman nauti natte), 101(import itertools)
# ==================================== 78 ====================================
