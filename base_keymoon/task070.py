# best: 78(jailctf merger) / others: 81(Code Golf International), 81(4atj sisyphus luke Seek mukundan), 82(ox jam), 87(import itertools), 101(jacekw Potatoman nauti natte)
# ==================================== 78 ====================================
