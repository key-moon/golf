# best: 67(Tony Li, JRKKX, THUNDER THUNDER, jailctf merger, 4atj sisyphus luke Seek mukundan, rucin93, ox jam, kambarakun, biz, cg-klogw-sekken, adakoda, import itertools, today) / others: 68(Ty Woods), 72(ShadowPrompt Labs), 72(jacekw Potatoman nauti natte), 72(Ravi Annaswamy), 74(kabutack)
