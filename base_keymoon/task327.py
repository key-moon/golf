# best: 67(open source, ï¾ï½²ï½½ï½¹ï¾ï½»ï¾ï¾ï¾II, Krige, Code Golf International, 4atj sisyphus luke Seek mukundan, Team JYCDT, lv1.dev, LogicLynx, rucin93, today, ALE-Agent, santa2024, cg-klogw-sekken, FuunAgent, kambarakun, import itertools, Tony Li, jailctf merger, Tony Li & Darren Amadeus Martin, HIMAGINE THE FUTURE., adakoda, ox jam, THUNDER THUNDER, biz, intgrah jimboko awu macaque sammyuri, JRKKX) / others: 68(Ty Woods), 72(jacekw Potatoman nauti natte), 72(Ravi Annaswamy), 74(JRKX), 74(HETHAT)
