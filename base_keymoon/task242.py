# best: 54(cubbus, jacekw Potatoman nauti natte, JRKX, 4atj sisyphus luke Seek mukundan, natte, kabutack, JRKXK, import itertools, jailctf merger, ox jam, intgrah jimboko awu macaque sammyuri, JRKKX) / others: 56(jacekwl Potatoman nauti), 56(jacekw Potatoman nauti), 56(Yuchen20), 66(HETHAT), 66(cg-klogw-sekken)
