# best: 54(4atj sisyphus luke Seek mukundan, 4atj sisyphus luke Seek, kabutack, jailctf merger, intgrah jimboko awu macaque sammyuri, xsot ovs att joking mewheni, mukundan) / others: 56(nauti), 66(duckyluuk), 66(HETHAT), 68(cg), 81(MasukenSamba)
