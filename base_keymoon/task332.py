# best: 58(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 61(ox jam), 64(jacekwl Potatoman nauti), 64(jacekw Potatoman nauti natte), 64(jacekw Potatoman nauti), 64(import itertools)
