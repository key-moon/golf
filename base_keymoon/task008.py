# best: 84(Code Golf International, 4atj sisyphus luke Seek mukundan, jailctf merger) / others: 94(ox jam), 99(jacekw Potatoman nauti natte), 99(import itertools), 99(HIMAGINE THE FUTURE.), 103(natte)
