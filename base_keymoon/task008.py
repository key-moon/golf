# best: 84(Code Golf International, 4atj sisyphus luke Seek mukundan, jailctf merger) / others: 90(ox jam), 97(ALE-Agent), 99(jacekw Potatoman nauti natte), 99(import itertools), 99(HIMAGINE THE FUTURE.)
