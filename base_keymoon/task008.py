# best: 84(4atj sisyphus luke Seek mukundan, Code Golf International) / others: 94(ox jam), 99(jacekw Potatoman nauti natte), 99(import itertools), 103(jailctf merger), 103(natte)
