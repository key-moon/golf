# best: 60(4atj sisyphus luke Seek mukundan, jailctf merger, intgrah jimboko awu macaque sammyuri) / others: 66(HETHAT), 66(ox jam), 67(jonas ryno kg583 kabutack), 67(JRK), 67(JRKX)
# =========================== 60 ===========================
