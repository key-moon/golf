# best: 60(jacekw Potatoman nauti natte, Code Golf International, 4atj sisyphus luke Seek mukundan, lv1.dev, import itertools, jailctf merger, intgrah jimboko awu macaque sammyuri) / others: 61(LogicLynx), 61(FuunAgent), 61(HIMAGINE THE FUTURE.), 61(ox jam), 62(ALE-Agent)
# =========================== 60 ===========================
