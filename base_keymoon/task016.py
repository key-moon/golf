# best: 43(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 44(ox jam), 44(xsot ovs att joking mewheni), 46(intgrah jimboko awu macaque sammyuri), 46(HETHAT), 47(cefqrn)
# =================== 43 ==================
