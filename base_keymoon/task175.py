# best: 75(jailctf merger, ox jam, intgrah jimboko awu macaque sammyuri, import itertools) / others: 77(cg-klogw-sekken), 82(THUNDER THUNDER), 82(cg-klogw), 84(4atj sisyphus luke Seek mukundan), 87(jacekwl)
# =================================== 75 ==================================
