# best: 61(4atj sisyphus luke Seek mukundan, import itertools) / others: 63(jailctf merger), 63(biz), 65(ShadowPrompt Labs), 65(natte), 65(jacekw Potatoman nauti natte)
# 70
