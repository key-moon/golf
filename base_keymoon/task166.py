# best: 61(Code Golf International, 4atj sisyphus luke Seek mukundan, import itertools) / others: 63(jailctf merger), 63(biz), 65(jacekw Potatoman nauti natte), 65(ShadowPrompt Labs), 65(HETHAT)
# 70
