...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_apply(val_func_color,A);C=val_func_merge(A);D=val_func_lbind(val_func_val_func_colorfilter,A);E=val_func_rbind(val_func_argmax,val_func_rightmost);F=val_func_compose(E,D);G=mval_func_apply(F,B);H=val_func_difference(C,G);J=val_func_move(I,H,(0,1));return[*map(list,J)]