...
def val_func_multiply(a,b):
	...
	return a[0]*b,a[1]*b
def p(I):C=False;I=tuple(map(tuple,I));D=val_func_objects(I,C,C,True);A=val_func_first(D);B=val_func_hperiod(A);E=val_func_multiply(B,3);F=val_func_tojvec(B);G=val_func_tojvec(E);H=val_func_shift(A,F);J=val_func_shift(A,G);K=val_func_paint(I,H);L=val_func_paint(K,J);return[*map(list,L)]