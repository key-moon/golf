...
def p(I):A=False;I=tuple(map(tuple,I));B=val_func_objects(I,True,A,A);C=val_func_colorfilter(B,2);D=val_func_sizefilter(C,1);E=val_func_merge(D);F=val_func_fill(I,1,E);return[*map(list,F)]