...
def p(I):A=False;I=tuple(map(tuple,I));B=val_func_objects(I,True,A,A);C=val_func_argmax(B,val_func_height);D=val_func_subgrid(C,I);E=val_func_trim(D);return[*map(list,E)]