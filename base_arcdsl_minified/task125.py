...
def p(I):I=tuple(map(tuple,I));B=val_func_objects(I,True,False,True);A=val_func_colorfilter(B,6);C=mval_func_apply(val_func_outbox,A);D=val_func_fill(I,3,C);E=mval_func_apply(val_func_delta,A);F=val_func_fill(D,4,E);return[*map(list,F)]