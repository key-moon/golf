...
def p(A):A=tuple(map(tuple,A));B=val_func_ofcolor(A,3);C=val_func_height(B);D=val_func_equality(C,1);E=val_func_branch(D,(0,2),(2,0));F=val_func_ofcolor(A,2);G=val_func_recolor(2,F);H=val_func_move(A,G,E);return[*map(list,H)]