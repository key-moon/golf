...
def p(I):A=False;I=tuple(map(tuple,I));B=val_func_objects(I,True,A,A);C=val_func_colorfilter(B,0);D=val_func_rbind(val_func_bordering,I);E=val_func_compose(val_func_flip,D);F=val_func_mfilter(C,E);G=val_func_fill(I,4,F);return[*map(list,G)]