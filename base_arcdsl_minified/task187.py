...
def p(I):A=False;I=tuple(map(tuple,I));B=val_func_objects(I,True,A,A);C=val_func_rbind(val_func_bordering,I);D=val_func_compose(val_func_flip,C);E=val_func_mfilter(B,D);F=val_func_fill(I,2,E);G=val_func_replace(F,0,3);return[*map(list,G)]