...
def p(I):I=tuple(map(tuple,I));B=val_func_objects(I,True,False,True);A=val_func_sizefilter(B,8);C=val_func_dval_func_neighbors((1,1));D=val_func_insert((1,1),C);E=val_func_merge(A);F=val_func_cover(I,E);G=val_func_apply(val_func_ulcorner,A);H=val_func_lbind(val_func_shift,D);J=val_func_mval_func_apply(H,G);K=val_func_fill(F,2,J);return[*map(list,K)]