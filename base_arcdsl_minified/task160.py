...
def p(A):A=tuple(map(tuple,A));C=val_func_objects(A,True,False,True);B=val_func_sizefilter(C,8);D=val_func_dval_func_neighbors((1,1));E=val_func_insert((1,1),D);F=val_func_merge(B);G=val_func_cover(A,F);H=val_func_apply(val_func_ulcorner,B);I=val_func_lbind(val_func_shift,E);J=mval_func_apply(I,H);K=val_func_fill(G,2,J);return[*map(list,K)]