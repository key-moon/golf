...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_mval_func_apply(val_func_corners,A);C=val_func_underfill(I,1,B);return[*map(list,C)]