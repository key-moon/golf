...
def val_func_subtract(a,b):
	...
	return a[0]-b,a[1]-b
def p(I):I=tuple(map(tuple,I));C=val_func_shape(I);A=val_func_replace(I,9,0);D=val_func_lbind(val_func_apply,val_func_maximum);E=val_func_dmirror(A);F=val_func_pval_func_apply(val_func_pair,A,E);B=val_func_apply(D,F);G=val_func_subtract(C,(2,2));H=val_func_crop(B,(2,2),G);J=val_func_vmirror(H);K=val_func_objects(J,True,False,True);L=val_func_merge(K);M=val_func_shift(L,(2,2));N=val_func_paint(B,M);return[*map(list,N)]