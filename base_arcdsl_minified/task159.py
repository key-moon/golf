...
def val_func_divide(a,b):
	...
	return a[0]//b,a[1]//b
def p(I):A=True;I=tuple(map(tuple,I));C=val_func_objects(I,A,A,A);D=val_func_ofcolor(I,2);E=val_func_argmin(C,val_func_size);B=val_func_subgrid(D,I);F=val_func_width(B);G=val_func_divide(F,3);H=val_func_upscale(E,G);J=val_func_normalize(H);K=val_func_shift(J,(1,1));L=val_func_paint(B,K);return[*map(list,L)]