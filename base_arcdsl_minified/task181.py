...
def val_func_multiply(a,b):
	...
	return a[0]*b,a[1]*b
def p(I):I=tuple(map(tuple,I));A=val_func_ofcolor(I,4);B=val_func_ofcolor(I,8);C=val_func_ulcorner(A);D=val_func_index(I,C);E=val_func_equality(D,4);F=val_func_branch(E,-1,1);G=val_func_multiply(F,3);H=val_func_tojvec(G);J=val_func_vmirror(B);K=val_func_shift(J,H);L=val_func_fill(I,8,K);return[*map(list,L)]