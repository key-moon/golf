...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_first(A);C=val_func_move(I,B,(1,0));D=val_func_replace(C,8,2);return[*map(list,D)]