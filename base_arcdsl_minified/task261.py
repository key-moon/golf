...
def p(A):A=tuple(map(tuple,A));B=val_func_objects(A,True,False,True);C=val_func_first(B);D=val_func_move(A,C,(1,0));E=val_func_replace(D,8,2);return[*map(list,E)]