...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_fork(val_func_difference,val_func_toindices,val_func_box);C=val_func_mval_func_apply(B,A);D=val_func_fill(I,0,C);return[*map(list,D)]