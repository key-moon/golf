...
def val_func_multiply(a,b):
	...
	return a[0]*b,a[1]*b
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);C=val_func_size(A);B=val_func_multiply(C,5);D=val_func_astuple(B,B);E=val_func_canvas(0,D);F=val_func_rbind(val_func_shoot,(1,1));G=val_func_compose(F,val_func_center);H=val_func_fork(val_func_reval_func_color,val_func_color,G);J=mval_func_apply(H,A);K=val_func_paint(E,J);L=val_func_hmirror(K);return[*map(list,L)]