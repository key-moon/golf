...
def p(I):I=tuple(map(tuple,I));C=val_func_hmirror(I);D=val_func_vmirror(I);A=val_func_ofcolor(I,1);B=val_func_subgrid(A,C);E=val_func_subgrid(A,D);F=val_func_palette(B);G=val_func_contained(1,F);H=val_func_branch(G,E,B);return[*map(list,H)]