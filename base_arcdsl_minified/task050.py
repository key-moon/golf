...
def p(I):I=tuple(map(tuple,I));A=val_func_ofcolor(I,8);B=val_func_prapply(val_func_connect,A,A);C=val_func_rbind(val_func_greater,1);D=val_func_compose(C,val_func_size);E=val_func_sfilter(B,D);F=val_func_fork(val_func_either,val_func_vline,val_func_hline);G=val_func_mfilter(E,F);H=val_func_fill(I,3,G);J=val_func_fill(H,8,A);return[*map(list,J)]