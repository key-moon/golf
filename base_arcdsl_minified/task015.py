...
def p(I):I=tuple(map(tuple,I));A=val_func_ofcolor(I,1);B=val_func_ofcolor(I,2);C=val_func_mval_func_apply(val_func_dneighbors,A);D=val_func_mval_func_apply(val_func_ineighbors,B);E=val_func_fill(I,7,C);F=val_func_fill(E,4,D);return[*map(list,F)]