...
def val_func_multiply(a,b):
	...
	return a[0]*b,a[1]*b
def p(I):B=True;I=tuple(map(tuple,I));C=val_func_objects(I,B,B,B);D=val_func_neighbors((0,0));E=mval_func_apply(val_func_neighbors,D);F=val_func_rbind(val_func_multiply,3);G=val_func_apply(F,E);H=val_func_merge(C);J=val_func_lbind(val_func_shift,H);A=mval_func_apply(J,G);K=val_func_shift(A,(-1,1));L=val_func_shift(A,(1,-1));M=val_func_paint(I,A);N=val_func_paint(M,K);O=val_func_paint(N,L);return[*map(list,O)]