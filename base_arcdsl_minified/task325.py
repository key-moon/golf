...
def p(A):A=tuple(map(tuple,A));C=val_func_objects(A,True,False,True);B=val_func_size(C);D=val_func_astuple(B,B);E=val_func_canvas(0,D);F=val_func_shoot((0,0),(1,1));G=val_func_fill(E,8,F);return[*map(list,G)]