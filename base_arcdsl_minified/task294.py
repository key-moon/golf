...
def p(I):A=False;I=tuple(map(tuple,I));B=val_func_objects(I,True,A,A);C=val_func_colorfilter(B,5);D=val_func_compose(val_func_backdrop,val_func_inbox);E=mval_func_apply(D,C);F=val_func_fill(I,2,E);return[*map(list,F)]