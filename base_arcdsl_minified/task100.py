...
def val_func_multiply(A,B):
	...
	return A[0]*B,A[1]*B
def p(A):A=tuple(map(tuple,A));B=val_func_objects(A,True,False,True);C=val_func_fork(val_func_multiply,val_func_height,val_func_width);D=val_func_argmax(B,C);E=val_func_color(D);F=val_func_canvas(E,(2,2));return[*map(list,F)]