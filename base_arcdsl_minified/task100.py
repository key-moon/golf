...
def val_func_multiply(a,b):
	...
	return a[0]*b,a[1]*b
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_fork(val_func_multiply,val_func_height,val_func_width);C=val_func_argmax(A,B);D=val_func_color(C);E=val_func_canvas(D,(2,2));return[*map(list,E)]