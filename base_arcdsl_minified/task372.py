...
def p(I):I=tuple(map(tuple,I));A=val_func_tophalf(I);B=val_func_bottomhalf(I);C=val_func_objects(A,True,False,True);D=val_func_merge(C);E=val_func_paint(B,D);return[*map(list,E)]