...
def val_func_add(a,b):
	...
	return a[0]+b,a[1]+b
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,False,True,True);B=val_func_rbind(val_func_add,(1,0));C=val_func_compose(B,val_func_llcorner);D=val_func_compose(val_func_toivec,val_func_numcolors);E=val_func_fork(val_func_add,val_func_lrcorner,D);F=val_func_fork(val_func_astuple,C,E);G=val_func_compose(val_func_box,F);H=mval_func_apply(G,A);J=val_func_fill(I,3,H);return[*map(list,J)]