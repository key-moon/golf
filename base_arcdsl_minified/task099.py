...
def p(A):A=tuple(map(tuple,A));B=val_func_objects(A,True,False,True);C=val_func_colorfilter(B,1);D=val_func_rbind(val_func_toobject,A);E=val_func_chain(val_func_leastcolor,D,val_func_delta);F=val_func_rbind(val_func_shift,(-1,0));G=val_func_compose(F,val_func_backdrop);H=val_func_fork(val_func_recolor,E,G);I=mval_func_apply(H,C);J=val_func_underpaint(A,I);return[*map(list,J)]