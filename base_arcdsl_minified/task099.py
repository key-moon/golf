...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_colorfilter(A,1);C=val_func_rbind(val_func_toobject,I);D=val_func_chain(val_func_leastcolor,C,val_func_delta);E=val_func_rbind(val_func_shift,(-1,0));F=val_func_compose(E,val_func_backdrop);G=val_func_fork(val_func_recolor,D,F);H=mval_func_apply(G,B);J=val_func_underpaint(I,H);return[*map(list,J)]