...
def p(I):I=tuple(map(tuple,I));C=val_func_width(I);D=val_func_palette(I);E=val_func_halve(C);A=val_func_vupscale(I,E);F=val_func_rbind(val_func_shoot,(1,1));B=val_func_other(D,0);G=val_func_ofcolor(A,B);H=mval_func_apply(F,G);J=val_func_fill(A,B,H);return[*map(list,J)]