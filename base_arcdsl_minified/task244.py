...
def p(I):A=False;I=tuple(map(tuple,I));B=val_func_compress(I);C=val_func_objects(I,True,A,A);D=val_func_vmirror(B);E=val_func_valmin(C,val_func_width);F=val_func_downscale(D,E);return[*map(list,F)]