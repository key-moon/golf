...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,False,True,True);B=val_func_first(A);C=val_func_subgrid(B,I);D=val_func_lefthalf(C);E=val_func_tophalf(D);return[*map(list,E)]