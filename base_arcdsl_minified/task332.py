...
def p(I):I=tuple(map(tuple,I));A=val_func_vmirror(I);B=val_func_ofcolor(A,5);C=val_func_compose(val_func_even,val_func_last);D=val_func_sfilter(B,C);E=val_func_fill(A,3,D);F=val_func_vmirror(E);return[*map(list,F)]