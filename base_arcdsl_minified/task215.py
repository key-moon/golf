...
def val_func_multiply(a,b):
	...
	return a[0]*b,a[1]*b
def p(I):A=True;I=tuple(map(tuple,I));C=val_func_objects(I,A,A,A);B=val_func_first(C);D=val_func_interval(-2,4,1);E=val_func_lbind(val_func_shift,B);F=val_func_height(B);G=val_func_rbind(val_func_multiply,F);H=val_func_apply(G,D);J=val_func_apply(val_func_toivec,H);K=mval_func_apply(E,J);L=val_func_paint(I,K);return[*map(list,L)]