...
def p(I):I=tuple(map(tuple,I));B=val_func_objects(I,True,False,True);C=val_func_chain(ival_func_neighbors,val_func_last,val_func_first);D=val_func_fork(val_func_reval_func_color,val_func_color,C);E=mval_func_apply(D,B);F=val_func_paint(I,E);G=val_func_vsplit(F,3);A=val_func_first(G);H=val_func_vconcat(A,A);J=val_func_vconcat(A,H);return[*map(list,J)]