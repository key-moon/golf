...
def p(I):I=tuple(map(tuple,I));A=val_func_width(I);B=val_func_shoot((0,0),(1,1));C=val_func_decrement(A);D=val_func_tojvec(C);E=val_func_shoot(D,(1,-1));F=val_func_combine(B,E);G=val_func_fill(I,0,F);return[*map(list,G)]