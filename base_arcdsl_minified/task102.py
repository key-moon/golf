...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_apply(val_func_delta,A);C=val_func_mfilter(B,val_func_square);D=val_func_fill(I,2,C);return[*map(list,D)]