...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);C=val_func_colorfilter(A,2);B=val_func_first(C);D=val_func_colorfilter(A,8);E=val_func_first(D);F=val_func_gravitate(B,E);G=val_func_move(I,B,F);return[*map(list,G)]