...
def p(A):A=tuple(map(tuple,A));B=val_func_objects(A,True,False,True);C=val_func_sizefilter(B,1);D=val_func_merge(C);E=val_func_move(A,D,(2,0));return[*map(list,E)]