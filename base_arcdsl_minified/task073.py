...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_sizefilter(A,1);C=val_func_merge(B);D=val_func_move(I,C,(2,0));return[*map(list,D)]