...
def p(I):I=tuple(map(tuple,I));B=val_func_objects(I,False,True,True);C=val_func_matcher(val_func_numcolors,2);A=val_func_extract(B,C);D=val_func_subgrid(A,I);E=val_func_mostcolor(A);F=val_func_replace(D,8,E);return[*map(list,F)]