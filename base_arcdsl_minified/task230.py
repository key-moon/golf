...
def p(I):I=tuple(map(tuple,I));B=val_func_objects(I,True,False,True);A=val_func_apply(val_func_outbox,B);C=val_func_apply(val_func_ulcorner,A);D=val_func_apply(val_func_urcorner,A);E=val_func_apply(val_func_llcorner,A);F=val_func_apply(val_func_lrcorner,A);G=val_func_fill(I,1,C);H=val_func_fill(G,2,D);J=val_func_fill(H,3,E);K=val_func_fill(J,4,F);return[*map(list,K)]