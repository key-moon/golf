...
def p(I):I=tuple(map(tuple,I));B=val_func_rot270(I);A=val_func_objects(B,True,False,True);C=val_func_argmax(A,val_func_size);D=val_func_argmin(A,val_func_size);E=val_func_color(D);F=val_func_canvas(E,(3,3));G=val_func_normalize(C);H=val_func_paint(F,G);J=val_func_rot90(H);return[*map(list,J)]