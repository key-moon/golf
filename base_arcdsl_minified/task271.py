...
def p(I):A=False;I=tuple(map(tuple,I));B=val_func_objects(I,A,A,True);C=val_func_rbind(val_func_colorcount,1);D=val_func_argmax(B,C);E=val_func_subgrid(D,I);return[*map(list,E)]