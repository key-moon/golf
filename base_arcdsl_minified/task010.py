def val_func_papply(function,a,b):return tuple(function(A,B)for(A,B)in zip(a,b))
...
def val_func_mval_func_papply(function,a,b):return val_func_merge(val_func_papply(function,a,b))
...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_totuple(A);C=val_func_order(A,val_func_height);D=val_func_size(B);E=val_func_interval(D,0,-1);F=val_func_mval_func_papply(val_func_recolor,E,C);G=val_func_paint(I,F);return[*map(list,G)]