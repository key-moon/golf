...
def p(I):I=tuple(map(tuple,I));B=val_func_upscale(I,3);C=val_func_hconcat(I,I);A=val_func_hconcat(C,I);D=val_func_vconcat(A,A);E=val_func_vconcat(D,A);F=val_func_ofcolor(B,0);G=val_func_ofcolor(B,1);H=val_func_combine(F,G);J=val_func_fill(E,0,H);return[*map(list,J)]