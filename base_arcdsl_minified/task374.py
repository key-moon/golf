...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_replace(I,5,4);C=val_func_argmin(A,val_func_size);D=val_func_argmax(A,val_func_size);E=val_func_fill(B,1,D);F=val_func_fill(E,2,C);return[*map(list,F)]