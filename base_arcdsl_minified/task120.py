...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_compose(val_func_backdrop,val_func_inbox);C=mval_func_apply(B,A);D=val_func_fill(I,8,C);return[*map(list,D)]