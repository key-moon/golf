...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_rbind(val_func_shoot,(1,1));C=val_func_compose(B,val_func_center);D=val_func_fork(val_func_reval_func_color,val_func_color,C);E=mval_func_apply(D,A);F=val_func_astuple(6,6);G=val_func_canvas(0,F);H=val_func_paint(G,E);return[*map(list,H)]