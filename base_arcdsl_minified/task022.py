...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,False,True,True);B=val_func_matcher(val_func_first,5);C=val_func_rbind(val_func_sfilter,B);D=val_func_chain(val_func_invert,val_func_center,C);E=val_func_fork(val_func_shift,val_func_identity,D);F=val_func_canvas(0,(3,3));G=mval_func_apply(E,A);H=val_func_shift(G,(1,1));J=val_func_paint(F,H);return[*map(list,J)]