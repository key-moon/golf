...
def p(A):A=tuple(map(tuple,A));B=val_func_objects(A,False,True,True);C=val_func_matcher(val_func_first,5);D=val_func_rbind(val_func_sfilter,C);E=val_func_chain(val_func_invert,val_func_center,D);F=val_func_fork(val_func_shift,val_func_identity,E);G=val_func_canvas(0,(3,3));H=mval_func_apply(F,B);I=val_func_shift(H,(1,1));J=val_func_paint(G,I);return[*map(list,J)]