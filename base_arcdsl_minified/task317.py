...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_apply(val_func_outbox,A);C=mval_func_apply(val_func_backdrop,B);D=val_func_fill(I,1,C);return[*map(list,D)]