...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_colorfilter(A,2);C=val_func_mval_func_apply(val_func_outbox,B);D=val_func_fill(I,1,C);return[*map(list,D)]