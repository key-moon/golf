...
def p(I):I=tuple(map(tuple,I));A=val_func_objects(I,True,False,True);B=val_func_fork(val_func_combine,val_func_vfrontier,val_func_hfrontier);C=val_func_compose(B,val_func_center);D=mval_func_apply(C,A);E=val_func_underfill(I,6,D);return[*map(list,E)]