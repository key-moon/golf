# best: 71(ox jam, 4atj sisyphus luke Seek mukundan, jailctf merger) / others: 72(jacekw Potatoman nauti), 74(JRKX), 75(HETHAT), 75(xsot ovs att joking mewheni), 77(natte)
# ================================= 71 ================================
