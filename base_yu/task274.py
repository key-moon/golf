# best: 71(jacekw Potatoman nauti natte, Code Golf International, 4atj sisyphus luke Seek mukundan, import itertools, jailctf merger, HIMAGINE THE FUTURE., ox jam, biz) / others: 72(jacekw Potatoman nauti), 74(JRKX), 74(JRKXK), 74(JRKKX), 75(HETHAT)
# ================================= 71 ================================
