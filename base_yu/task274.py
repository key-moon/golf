# best: 71(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 75(xsot ovs att joking mewheni), 77(natte), 77(kabutack), 79(MasukenSamba), 81(jacekwl Potatoman nauti)
# ================================= 71 ================================
