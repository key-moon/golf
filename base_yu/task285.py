# best: 286(jailctf merger) / others: 296(ox jam), 297(jacekw Potatoman nauti natte), 316(intgrah jimboko awu macaque sammyuri), 318(natte), 326(4atj sisyphus luke Seek mukundan)
def p(g):
 for _ in range(8):
