# best: 191(ox jam, 4atj sisyphus luke Seek mukundan) / others: 233(jailctf merger), 245(natte), 252(jacekw Potatoman nauti), 252(jacekwl Potatoman nauti), 253(jacekwl)
# ============================================================================================ 191 ============================================================================================
def p(g):
 h,w=len(g),len(g[0])
