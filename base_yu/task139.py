# best: 90(biz) / others: 93(jailctf merger), 95(intgrah jimboko awu macaque sammyuri), 99(Code Golf International), 99(4atj sisyphus luke Seek mukundan), 100(import itertools)
# ========================================== 90 ==========================================
