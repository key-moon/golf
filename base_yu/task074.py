# best: 79(4atj sisyphus luke Seek mukundan) / others: 80(ox jam), 80(jailctf merger), 80(xsot ovs att joking mewheni), 84(intgrah jimboko awu macaque sammyuri), 107(natte)
# ===================================== 79 ====================================
