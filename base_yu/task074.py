# best: 77(jailctf merger) / others: 79(4atj sisyphus luke Seek mukundan), 79(Code Golf International), 80(ox jam), 83(intgrah jimboko awu macaque sammyuri), 84(MasukenSamba)
# ==================================== 77 ===================================
