# best: 156(jailctf merger) / others: 167(4atj sisyphus luke Seek mukundan), 167(ox jam), 173(Yuchen20), 180(jacekw Potatoman nauti natte), 183(jacekwl Potatoman nauti)
def p(g):
 R=range(11)
