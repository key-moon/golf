# best: 156(jailctf merger) / others: 167(4atj sisyphus luke Seek mukundan), 167(xsot ovs att joking mewheni), 186(intgrah jimboko awu macaque sammyuri), 190(Yuchen20), 195(jonas ryno kg583)
def p(g):
 R=range(11)
