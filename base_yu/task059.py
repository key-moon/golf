# best: 156(jailctf merger) / others: 167(4atj sisyphus luke Seek mukundan), 167(ox jam), 173(Yuchen20), 178(intgrah jimboko awu macaque sammyuri), 180(jacekw Potatoman nauti natte)
def p(g):
 R=range(11)
