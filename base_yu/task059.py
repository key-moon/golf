# best: 156(jailctf merger) / others: 167(ox jam), 167(4atj sisyphus luke Seek mukundan), 167(xsot ovs att joking mewheni), 173(Yuchen20), 183(jacekwl Potatoman nauti)
def p(g):
 R=range(11)
