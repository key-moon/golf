# best: 156(jailctf merger) / others: 167(4atj sisyphus luke Seek mukundan), 167(xsot ovs att joking mewheni), 176(Yuchen20), 183(jacekwl Potatoman nauti), 186(intgrah jimboko awu macaque sammyuri)
def p(g):
 R=range(11)
