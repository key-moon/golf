# best: 70(jacekw Potatoman nauti natte, import itertools, jailctf merger) / others: 76(jonas ryno kg583 kabutack), 76(JRK), 76(JRKX), 76(4atj sisyphus luke Seek mukundan), 76(jonas ryno kg583)
# ================================ 70 ================================
