# 類題:254
# best: 68(jacekw Potatoman nauti natte, import itertools, jailctf merger) / others: 70(4atj sisyphus luke Seek mukundan), 72(cubbus), 72(ox jam), 77(HETHAT), 77(intgrah jimboko awu macaque sammyuri)
# =============================== 68 ===============================
