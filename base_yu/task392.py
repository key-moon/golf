# best: 149(biz) / others: 156(4atj sisyphus luke Seek mukundan), 157(intgrah jimboko awu macaque sammyuri), 161(MasukenSamba), 161(garrymoss), 177(xsot ovs att joking mewheni)
# ======================================================================= 149 =======================================================================
# def p(g):
