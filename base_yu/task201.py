# best: 208(jailctf merger, xsot ovs att joking mewheni) / others: 218(4atj sisyphus luke Seek mukundan), 255(natte), 280(MasukenSamba), 307(jonas ryno kg583), 313(J&R)
def p(g):
 t=sum(g,[])
