# best: 320(jailctf merger) / others: 323(ox jam), 338(jacekw Potatoman nauti natte), 338(import itertools), 339(cg-klogw-sekken), 359(4atj sisyphus luke Seek mukundan)
def p(g):
