# best: 323(ox jam, jailctf merger, xsot ovs att joking mewheni) / others: 371(natte), 392(sekken), 406(jacekw Potatoman nauti), 406(jacekwl Potatoman nauti), 411(MasukenSamba)
def p(g):
