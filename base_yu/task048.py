# best: 92(jailctf merger) / others: 95(Code Golf International), 95(4atj sisyphus luke Seek mukundan), 118(ox jam), 128(jacekw Potatoman nauti natte), 128(import itertools)
# 141
