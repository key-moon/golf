# best: 54(jailctf merger, ox jam) / others: 60(jacekw Potatoman nauti natte), 60(Code Golf International), 60(4atj sisyphus luke Seek mukundan), 60(import itertools), 61(HIMAGINE THE FUTURE.)
# ======================== 54 ========================
