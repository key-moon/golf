# best: 91(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 92(ox jam), 92(xsot ovs att joking mewheni), 95(kdmitrie), 95(jonas ryno kg583 kabutack), 95(jonas ryno kg583)
# =========================================== 91 ==========================================
# r=range
# def p(g):
#  h,w=len(g),len(g[0])
