# best: 58(jacekw Potatoman nauti natte, natte) / others: 60(jailctf merger), 60(intgrah jimboko awu macaque sammyuri), 61(jonas ryno kg583 kabutack), 61(open source), 61(cubbus)
# ========================== 58 ==========================
