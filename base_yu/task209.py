# best: 290(jonas ryno kg583) / others: 292(jailctf merger), 292(xsot ovs att joking mewheni), 312(4atj sisyphus luke Seek mukundan), 317(4atj sisyphus luke Seek), 383(Afordancja)
def p(g):
