# best: 289(jailctf merger) / others: 290(jonas ryno kg583 kabutack), 290(jonas ryno kg583), 292(ox jam), 292(xsot ovs att joking mewheni), 312(4atj sisyphus luke Seek mukundan)
def p(g):
