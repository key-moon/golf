# best: 292(jailctf merger, xsot ovs att joking mewheni) / others: 317(4atj sisyphus luke Seek mukundan), 317(4atj sisyphus luke Seek), 383(Afordancja), 393(kdmitrie), 446(intgrah jimboko awu macaque sammyuri)
def p(g):
