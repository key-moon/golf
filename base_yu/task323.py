# best: 102(jailctf merger) / others: 106(4atj sisyphus luke Seek mukundan), 122(4atj sisyphus luke Seek), 122(mukundan), 125(xsot ovs att joking mewheni), 150(jacekwl Potatoman)
# =============================================== 102 ================================================
# def p(g,R=range(13)):
