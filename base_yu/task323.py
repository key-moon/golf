# best: 102(jailctf merger) / others: 106(4atj sisyphus luke Seek mukundan), 125(ox jam), 125(xsot ovs att joking mewheni), 143(intgrah jimboko awu macaque sammyuri), 150(jacekwl)
# =============================================== 102 ================================================
# def p(g,R=range(13)):
