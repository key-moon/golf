# best: 102(jailctf merger) / others: 106(4atj sisyphus luke Seek mukundan), 125(xsot ovs att joking mewheni), 150(jacekwl), 150(jacekwl Potatoman nauti), 153(Yuchen20)
# =============================================== 102 ================================================
# def p(g,R=range(13)):
