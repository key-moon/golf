# best: 48(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 49(ox jam), 49(intgrah jimboko awu macaque sammyuri), 54(Potatoman), 54(jacekw Potatoman nauti), 54(MasukenSamba)
# ===================== 48 =====================
