# best: 48(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 49(4atj sisyphus luke Seek), 49(intgrah jimboko awu macaque sammyuri), 49(xsot ovs att joking mewheni), 49(mukundan), 54(Potatoman)
# ===================== 48 =====================
