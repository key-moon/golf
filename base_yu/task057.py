# best: 48(jailctf merger, 4atj sisyphus luke Seek mukundan) / others: 49(ox jam), 49(intgrah jimboko awu macaque sammyuri), 51(THUNDER THUNDER), 54(Potatoman), 54(jacekw Potatoman nauti natte)
# ===================== 48 =====================
