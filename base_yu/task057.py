# best: 48(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 49(ox jam), 49(intgrah jimboko awu macaque sammyuri), 49(xsot ovs att joking mewheni), 54(Potatoman), 54(jacekw Potatoman nauti)
# ===================== 48 =====================
