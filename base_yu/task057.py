# best: 48(Code Golf International, 4atj sisyphus luke Seek mukundan, jailctf merger) / others: 49(ox jam), 49(biz), 49(intgrah jimboko awu macaque sammyuri), 51(lv1.dev), 51(ALE-Agent)
# ===================== 48 =====================
