# best: 82(jailctf merger) / others: 94(4atj sisyphus luke Seek mukundan), 94(ox jam), 95(intgrah jimboko awu macaque sammyuri), 110(jonas ryno kg583 kabutack), 110(JRKX)
# ====================================== 82 ======================================
