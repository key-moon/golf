# best: 98(jailctf merger, ox jam) / others: 99(Code Golf International), 106(4atj sisyphus luke Seek mukundan), 109(ï¾ï½²ï½½ï½¹ï¾ï½»ï¾ï¾ï¾II), 115(intgrah jimboko awu macaque sammyuri), 116(import itertools)
# ============================================== 98 ==============================================
