# best: 223(jailctf merger, ox jam) / others: 233(4atj sisyphus luke Seek mukundan), 246(jacekw Potatoman nauti natte), 260(natte), 264(intgrah jimboko awu macaque sammyuri), 265(jonas ryno kg583 kabutack)
def p(g):
