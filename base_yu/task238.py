# best: 223(jailctf merger) / others: 225(xsot ovs att joking mewheni), 233(4atj sisyphus luke Seek mukundan), 233(4atj sisyphus luke Seek), 265(kg583), 265(jonas ryno kg583)
R=range
def p(g):
