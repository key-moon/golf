# best: 223(ox jam, jailctf merger, xsot ovs att joking mewheni) / others: 233(4atj sisyphus luke Seek mukundan), 260(natte), 265(JRKX), 265(jonas ryno kg583 kabutack), 265(jonas ryno kg583)
def p(g):
