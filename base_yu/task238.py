# best: 222(jailctf merger) / others: 223(ox jam), 228(HIMAGINE THE FUTURE.), 233(Code Golf International), 233(4atj sisyphus luke Seek mukundan), 245(jacekw Potatoman nauti natte)
def p(g):
