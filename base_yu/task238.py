# best: 223(jailctf merger, xsot ovs att joking mewheni) / others: 233(4atj sisyphus luke Seek mukundan), 260(natte), 265(jonas ryno kg583), 269(MasukenSamba), 314(kdmitrie)
R=range
def p(g):
