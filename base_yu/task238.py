# best: 222(jailctf merger) / others: 223(ox jam), 233(4atj sisyphus luke Seek mukundan), 245(jacekw Potatoman nauti natte), 245(import itertools), 257(cg-klogw-sekken)
def p(g):
