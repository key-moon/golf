# best: 206(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 218(ox jam), 255(jacekw Potatoman nauti natte), 271(jacekwl Potatoman nauti), 271(jacekw Potatoman nauti), 275(MasukenSamba)
def p(g):
