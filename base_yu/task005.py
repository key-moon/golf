# best: 206(4atj sisyphus luke Seek mukundan) / others: 218(ox jam), 223(jailctf merger), 271(jacekw Potatoman nauti), 271(jacekwl Potatoman nauti), 275(MasukenSamba)
def p(g):
