# best: 183(jailctf merger) / others: 206(4atj sisyphus luke Seek mukundan), 218(ox jam), 253(jacekw Potatoman nauti natte), 271(jacekwl Potatoman nauti), 271(jacekw Potatoman nauti)
def p(g):
