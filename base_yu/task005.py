# best: 183(jailctf merger) / others: 206(4atj sisyphus luke Seek mukundan), 218(ox jam), 253(jacekw Potatoman nauti natte), 253(import itertools), 271(jacekwl Potatoman nauti)
def p(g):
