# best: 206(4atj sisyphus luke Seek mukundan) / others: 218(ox jam), 218(xsot ovs att joking mewheni), 223(jailctf merger), 271(jacekwl Potatoman nauti), 275(MasukenSamba)
def p(g):
 u=sum(g,[])
