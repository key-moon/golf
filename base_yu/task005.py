# best: 206(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 218(ox jam), 271(jacekwl Potatoman nauti), 271(jacekw Potatoman nauti), 275(MasukenSamba), 278(jacekwl)
def p(g):
