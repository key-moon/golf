# best: 242(jacekw Potatoman nauti natte, import itertools) / others: 258(jailctf merger), 260(ox jam), 263(natte), 272(ShadowPrompt Labs), 282(Code Golf International)
def p(g):
