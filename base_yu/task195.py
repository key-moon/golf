# best: 105(Code Golf International, 4atj sisyphus luke Seek mukundan, HIMAGINE THE FUTURE., ox jam, biz, intgrah jimboko awu macaque sammyuri) / others: 106(jacekw Potatoman nauti natte), 106(import itertools), 106(Yuchen20), 107(natte), 108(jonas ryno kg583 kabutack)
# ================================================= 105 =================================================
