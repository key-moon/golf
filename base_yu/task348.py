# best: 94(ox jam) / others: 101(jailctf merger), 105(Code Golf International), 105(4atj sisyphus luke Seek mukundan), 105(import itertools), 106(ï¾ï½²ï½½ï½¹ï¾ï½»ï¾ï¾ï¾II)
# ============================================ 94 ============================================
