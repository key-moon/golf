# best: 94(ox jam) / others: 101(jailctf merger), 101(HIMAGINE THE FUTURE.), 105(Code Golf International), 105(4atj sisyphus luke Seek mukundan), 105(import itertools)
# ============================================ 94 ============================================
