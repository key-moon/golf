# best: 365(xsot ovs att joking mewheni, ox jam) / others: 369(jailctf merger), 371(4atj sisyphus luke Seek mukundan), 374(HashPanda Pooja), 374(garrymoss), 374(Rafael Pooja)
def p(g):
