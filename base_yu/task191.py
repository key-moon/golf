# best: 238(jailctf merger) / others: 246(intgrah jimboko awu macaque sammyuri), 250(ox jam), 269(4atj sisyphus luke Seek mukundan), 276(jacekw Potatoman nauti natte), 289(natte)
def p(g):
