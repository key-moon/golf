# best: 241(jailctf merger) / others: 255(ox jam), 255(xsot ovs att joking mewheni), 269(4atj sisyphus luke Seek mukundan), 289(natte), 312(jonas ryno kg583 kabutack)
def p(g):
