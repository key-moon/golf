# best: 238(jailctf merger) / others: 244(jacekw Potatoman nauti natte), 244(import itertools), 246(intgrah jimboko awu macaque sammyuri), 250(ox jam), 269(Code Golf International)
def p(g):
