# best: 53(jailctf merger, ox jam) / others: 56(Code Golf International), 56(4atj sisyphus luke Seek mukundan), 56(HIMAGINE THE FUTURE.), 59(jacekw Potatoman nauti natte), 59(import itertools)
# ======================== 53 =======================
