# best: 255(4atj sisyphus luke Seek mukundan, intgrah jimboko awu macaque sammyuri) / others: 261(natte), 279(jailctf merger), 281(ox jam), 306(jacekw Potatoman nauti), 358(MasukenSamba)
# R=range
# def p(g):
#  for c in R(10):
