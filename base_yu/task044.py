# best: 195(jailctf merger) / others: 222(ox jam), 239(jacekw Potatoman nauti natte), 253(intgrah jimboko awu macaque sammyuri), 255(4atj sisyphus luke Seek mukundan), 261(natte)
# R=range
# def p(g):
#  for c in R(10):
