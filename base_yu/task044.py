# best: 195(jailctf merger) / others: 222(ox jam), 223(HIMAGINE THE FUTURE.), 239(jacekw Potatoman nauti natte), 239(import itertools), 244(intgrah jimboko awu macaque sammyuri)
# R=range
# def p(g):
#  for c in R(10):
