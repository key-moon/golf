# best: 195(jailctf merger) / others: 239(jacekw Potatoman nauti natte), 255(4atj sisyphus luke Seek mukundan), 255(intgrah jimboko awu macaque sammyuri), 261(natte), 281(ox jam)
# R=range
# def p(g):
#  for c in R(10):
