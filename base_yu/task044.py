# best: 255(4atj sisyphus luke Seek mukundan) / others: 261(natte), 279(jailctf merger), 281(xsot ovs att joking mewheni), 292(intgrah jimboko awu macaque sammyuri), 358(MasukenSamba)
# R=range
# def p(g):
#  for c in R(10):
