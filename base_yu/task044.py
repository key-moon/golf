# best: 255(4atj sisyphus luke Seek mukundan) / others: 261(natte), 281(xsot ovs att joking mewheni), 285(jailctf merger), 292(intgrah jimboko awu macaque sammyuri), 358(MasukenSamba)
# R=range
# def p(g):
#  for c in R(10):
