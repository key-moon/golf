# best: 135(jailctf merger) / others: 140(jacekw Potatoman nauti natte), 140(ox jam), 140(import itertools), 152(4atj sisyphus luke Seek mukundan), 152(Code Golf International)
# ================================================================ 135 ================================================================
# def p(g,R=range):
