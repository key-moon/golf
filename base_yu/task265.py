# best: 104(4atj sisyphus luke Seek mukundan) / others: 118(jailctf merger), 130(ox jam), 142(intgrah jimboko awu macaque sammyuri), 148(jacekwl Potatoman nauti), 148(jacekwl)
# ================================================ 104 =================================================
R=range
def p(g):
 for i in R(289):
