# best: 110(jailctf merger) / others: 112(4atj sisyphus luke Seek mukundan), 112(Code Golf International), 112(ox jam), 117(import itertools), 122(jacekw Potatoman nauti natte)
