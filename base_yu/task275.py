# best: 136(ox jam) / others: 145(jailctf merger), 156(4atj sisyphus luke Seek mukundan), 169(intgrah jimboko awu macaque sammyuri), 171(jacekw Potatoman nauti), 179(natte)
# ================================================================ 136 =================================================================
def p(g):
 n=len(g[0])
 R=range(n*n)
