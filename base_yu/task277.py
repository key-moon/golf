# best: 164(jailctf merger) / others: 189(intgrah jimboko awu macaque sammyuri), 194(4atj sisyphus luke Seek mukundan), 194(Code Golf International), 194(ox jam), 196(JRKKX)
# ============================================================================== 164 ===============================================================================
def p(g):
 t=[]
 for y in range(10):
