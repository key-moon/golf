# best: 164(jailctf merger) / others: 194(4atj sisyphus luke Seek mukundan), 194(ox jam), 194(intgrah jimboko awu macaque sammyuri), 243(jacekw Potatoman nauti natte), 243(Yuchen20)
# ============================================================================== 164 ===============================================================================
def p(g):
 t=[]
 for y in range(10):
