# best: 54(ox jam, 4atj sisyphus luke Seek mukundan, jailctf merger) / others: 60(HETHAT), 62(intgrah jimboko awu macaque sammyuri), 63(cubbus), 63(duckyluuk), 63(JRKX)
# ======================== 54 ========================
