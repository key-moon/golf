# best: 297(jailctf merger) / others: 299(xsot ovs att joking mewheni), 355(jacekwl Potatoman nauti), 367(4atj sisyphus luke Seek mukundan), 370(kdmitrie), 370(garrymoss)
def p(g):
