# best: 297(jailctf merger) / others: 299(xsot ovs att joking mewheni), 336(natte), 355(jacekwl Potatoman nauti), 367(4atj sisyphus luke Seek mukundan), 370(Rafael Pooja)
def p(g):
