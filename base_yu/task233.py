# best: 286(jailctf merger) / others: 297(ox jam), 315(jacekw Potatoman nauti natte), 336(natte), 341(intgrah jimboko awu macaque sammyuri), 355(jacekwl Potatoman nauti)
def p(g):
 u=[[*s]for s in g]
 for _ in range(80):
