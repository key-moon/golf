# best: 62(ox jam, 4atj sisyphus luke Seek mukundan, 2F, biz, jailctf merger, xsot ovs att joking mewheni) / others: 63(natte), 63(JRKX), 63(jacekw Potatoman nauti), 63(kabutack), 63(jonas ryno kg583 kabutack)
# ============================ 62 ============================
# def p(g):
