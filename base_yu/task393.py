# best: 63(ShadowPrompt Labs, kabutack, JRKKX, jacekwl, jailctf merger, natte, JRKXK, 4atj sisyphus luke Seek mukundan, Potatoman, jacekw Potatoman nauti natte, Code Golf International, JRKX, ox jam, MasukenSamba, intgrah jimboko awu macaque sammyuri, jacekwl Potatoman nauti, adakoda, jacekw Potatoman nauti, import itertools) / others: 64(Yuchen20), 66(cg-klogw), 66(cg-klogw-sekken), 68(Tony Li), 70(sekken)
# ============================= 63 ============================
