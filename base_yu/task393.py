# best: 63(jacekwl Potatoman nauti, jacekw Potatoman nauti natte, ï¾ï½²ï½½ï½¹ï¾ï½»ï¾ï¾ï¾II, JRKX, Code Golf International, 4atj sisyphus luke Seek mukundan, jacekwl, ShadowPrompt Labs, jacekw Potatoman nauti, natte, kabutack, JRKXK, import itertools, MasukenSamba, Potatoman, jailctf merger, HIMAGINE THE FUTURE., adakoda, ox jam, biz, JRKKX) / others: 64(Yuchen20), 66(cg-klogw-sekken), 66(cg-klogw), 68(Tony Li), 68(Tony Li & Darren Amadeus Martin)
# ============================= 63 ============================
