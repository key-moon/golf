# best: 112(jailctf merger) / others: 115(4atj sisyphus luke Seek mukundan), 116(ox jam), 125(intgrah jimboko awu macaque sammyuri), 134(jacekw Potatoman nauti natte), 161(Afordancja)
# ==================================================== 112 =====================================================
# def p(g):
#  w=1-any(g[1])
#  u=g[w:]
