# best: 89(ox jam) / others: 90(Code Golf International), 90(jailctf merger), 93(jacekw Potatoman nauti natte), 93(import itertools), 93(intgrah jimboko awu macaque sammyuri)
# ========================================== 89 =========================================
# def p(g):
#  u=[*zip(*g)]
# #  R=range(10)
