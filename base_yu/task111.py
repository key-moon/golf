# best: 60(Code Golf International, 4atj sisyphus luke Seek mukundan, lv1.dev, import itertools, jailctf merger, ox jam) / others: 61(jonas ryno kg583 kabutack), 61(JRK), 61(JRKX), 61(jonas ryno kg583), 61(LogicLynx)
# =========================== 60 ===========================
