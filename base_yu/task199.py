# best: 84(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 102(ox jam), 102(jacekwl Potatoman nauti), 102(xsot ovs att joking mewheni), 103(natte), 104(JRKX)
# ======================================= 84 =======================================
