# best: 99(jailctf merger) / others: 102(ox jam), 109(4atj sisyphus luke Seek mukundan), 109(Code Golf International), 114(jacekw Potatoman nauti natte), 114(import itertools)
# =============================================== 99 ==============================================
...
# p=lambda g:[[max(g+[*zip(*g)],key=lambda t:(t[j]>0,sum(map(int.__eq__,s,t))))[j]for j in range(21)]for s in g]
