# best: 50(cubbus, jailctf merger) / others: 51(jonas ryno kg583 kabutack), 51(jacekwl Potatoman nauti), 51(jacekw Potatoman nauti natte), 51(JRKX), 51(Code Golf International)
# ====================== 50 ======================
