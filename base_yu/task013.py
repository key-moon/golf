# best: 140(Code Golf International, 4atj sisyphus luke Seek mukundan, jailctf merger) / others: 143(import itertools), 145(intgrah jimboko awu macaque sammyuri), 146(ox jam), 161(2F), 161(biz)
#  1 
