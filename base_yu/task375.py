# best: 53(jacekwl Potatoman nauti, jacekw Potatoman nauti natte, ï¾ï½²ï½½ï½¹ï¾ï½»ï¾ï¾ï¾II, JRKX, Code Golf International, 4atj sisyphus luke Seek mukundan, ShadowPrompt Labs, jacekw Potatoman nauti, natte, kabutack, JRKXK, import itertools, Tony Li, jailctf merger, Tony Li & Darren Amadeus Martin, adakoda, ox jam, THUNDER THUNDER, intgrah jimboko awu macaque sammyuri, JRKKX) / others: 57(MasukenSamba), 58(jonas ryno kg583 kabutack), 58(JRK), 58(jonas ryno kg583), 59(cg-klogw-sekken)
# ======================== 53 =======================
