# best: 67(ox jam, 4atj sisyphus luke Seek mukundan, jailctf merger) / others: 74(JRKX), 74(kabutack), 74(HETHAT), 86(Yuchen20), 87(intgrah jimboko awu macaque sammyuri)
# =============================== 67 ==============================
