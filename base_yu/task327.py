# best: 67(ox jam, 4atj sisyphus luke Seek mukundan, jailctf merger, xsot ovs att joking mewheni) / others: 74(kabutack), 74(HETHAT), 88(Bulmenisaurus), 89(natte), 89(Yuchen20)
# =============================== 67 ==============================
