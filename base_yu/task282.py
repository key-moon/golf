# best: 83(jailctf merger, ox jam) / others: 91(Code Golf International), 91(4atj sisyphus luke Seek mukundan), 97(HIMAGINE THE FUTURE.), 99(import itertools), 100(biz)
# ======================================= 83 ======================================
