# best: 214(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 233(ox jam), 237(intgrah jimboko awu macaque sammyuri), 252(MasukenSamba), 258(natte), 297(Yuchen20)
def p(g):
