# best: 194(jailctf merger) / others: 205(HIMAGINE THE FUTURE.), 214(Code Golf International), 214(4atj sisyphus luke Seek mukundan), 233(ox jam), 237(intgrah jimboko awu macaque sammyuri)
def p(g):
