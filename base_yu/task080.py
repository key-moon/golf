# best: 253(ox jam, xsot ovs att joking mewheni) / others: 270(jailctf merger), 277(jacekw Potatoman nauti), 277(jacekwl Potatoman nauti), 284(kdmitrie), 328(MasukenSamba)
def p(g):
