# best: 253(jailctf merger, ox jam) / others: 255(HIMAGINE THE FUTURE.), 255(THUNDER THUNDER), 259(import itertools), 270(ï¾ï½²ï½½ï½¹ï¾ï½»ï¾ï¾ï¾II), 276(jacekw Potatoman nauti natte)
def p(g):
