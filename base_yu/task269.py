# best: 63(4atj sisyphus luke Seek mukundan) / others: 64(ox jam), 64(jailctf merger), 64(xsot ovs att joking mewheni), 71(intgrah jimboko awu macaque sammyuri), 74(jacekwl Potatoman nauti)
# ============================= 63 ============================
