# best: 85(4atj sisyphus luke Seek mukundan, Code Golf International) / others: 88(jailctf merger), 88(ox jam), 96(jacekw Potatoman nauti natte), 96(import itertools), 97(ShadowPrompt Labs)
# ======================================== 85 =======================================
