# best: 85(Code Golf International, 4atj sisyphus luke Seek mukundan) / others: 88(jailctf merger), 88(HIMAGINE THE FUTURE.), 88(ox jam), 96(jacekw Potatoman nauti natte), 96(import itertools)
# ======================================== 85 =======================================
