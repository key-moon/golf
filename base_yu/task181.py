# best: 67(jacekw Potatoman nauti natte, import itertools, jailctf merger, ox jam) / others: 69(Code Golf International), 69(4atj sisyphus luke Seek mukundan), 69(MasukenSamba), 69(adakoda), 69(duckyluuk)
# =============================== 67 ==============================
