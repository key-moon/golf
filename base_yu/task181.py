# best: 67(ox jam, jailctf merger) / others: 69(duckyluuk), 69(4atj sisyphus luke Seek mukundan), 69(MasukenSamba), 69(intgrah jimboko awu macaque sammyuri), 70(natte)
# =============================== 67 ==============================
