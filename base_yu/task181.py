# best: 67(jailctf merger, ox jam) / others: 69(4atj sisyphus luke Seek mukundan), 69(MasukenSamba), 69(duckyluuk), 69(intgrah jimboko awu macaque sammyuri), 70(natte)
# =============================== 67 ==============================
