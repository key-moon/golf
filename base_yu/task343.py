# best: 65(jailctf merger) / others: 74(4atj sisyphus luke Seek mukundan), 75(xsot ovs att joking mewheni), 77(intgrah jimboko awu macaque sammyuri), 106(MasukenSamba), 112(natte)
# ============================== 65 =============================
