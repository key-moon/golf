# best: 102(jailctf merger, intgrah jimboko awu macaque sammyuri) / others: 105(Code Golf International), 105(4atj sisyphus luke Seek mukundan), 105(import itertools), 106(HIMAGINE THE FUTURE.), 106(ox jam)
# =============================================== 102 ================================================
