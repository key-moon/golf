# best: 105(jailctf merger, 4atj sisyphus luke Seek mukundan, Code Golf International, ox jam) / others: 114(import itertools), 127(THUNDER THUNDER), 144(biz), 153(adakoda), 154(jacekw Potatoman nauti natte)
# ================================================= 105 =================================================
