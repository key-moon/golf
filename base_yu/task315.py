# best: 63(jacekw Potatoman nauti natte, 4atj sisyphus luke Seek mukundan, HETHAT, natte, jailctf merger, ox jam, intgrah jimboko awu macaque sammyuri) / others: 64(JRKX), 64(jacekw Potatoman nauti), 64(cg-klogw-sekken), 64(kabutack), 64(JRKXK)
# ============================= 63 ============================
