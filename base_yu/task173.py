# best: 217(jailctf merger) / others: 219(4atj sisyphus luke Seek mukundan), 222(open source), 222(jacekwl Potatoman nauti), 222(jacekw Potatoman nauti natte), 222(Ali)
def p(g):
