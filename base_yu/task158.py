# best: 263(intgrah jimboko awu macaque sammyuri) / others: 269(jailctf merger), 269(ox jam), 284(HIMAGINE THE FUTURE.), 319(cg-klogw-sekken), 322(Code Golf International)
def p(g):
