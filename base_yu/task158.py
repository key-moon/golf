# best: 267(intgrah jimboko awu macaque sammyuri) / others: 269(jailctf merger), 269(ox jam), 319(cg-klogw-sekken), 322(Code Golf International), 322(4atj sisyphus luke Seek mukundan)
def p(g):
