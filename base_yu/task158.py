# best: 269(xsot ovs att joking mewheni, ox jam, jailctf merger) / others: 322(4atj sisyphus luke Seek mukundan), 325(HashPanda Pooja), 325(garrymoss), 325(Rafael Pooja), 325(natte)
def p(g):
