# best: 269(jailctf merger, ox jam) / others: 272(intgrah jimboko awu macaque sammyuri), 319(cg-klogw-sekken), 322(Code Golf International), 322(4atj sisyphus luke Seek mukundan), 323(kambarakun)
def p(g):
