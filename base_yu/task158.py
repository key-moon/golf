# best: 269(jailctf merger, ox jam) / others: 281(intgrah jimboko awu macaque sammyuri), 319(cg-klogw-sekken), 322(4atj sisyphus luke Seek mukundan), 325(open source), 325(jacekwl Potatoman nauti)
def p(g):
