# best: 75(natte, 4atj sisyphus luke Seek mukundan, jailctf merger, intgrah jimboko awu macaque sammyuri, HETHAT) / others: 76(biz), 76(xsot ovs att joking mewheni), 80(dbdr), 80(kabutack), 86(cg)
# =================================== 75 ==================================
# R=range(10)
