# best: 75(natte, ox jam, 4atj sisyphus luke Seek mukundan, jacekw Potatoman nauti, jailctf merger, intgrah jimboko awu macaque sammyuri, Yuchen20, HETHAT, xsot ovs att joking mewheni) / others: 76(2F), 76(biz), 76(cg-klogw), 80(JRKX), 80(dbdr)
# =================================== 75 ==================================
# R=range(10)
