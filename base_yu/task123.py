# best: 75(natte, 4atj sisyphus luke Seek mukundan, 4atj sisyphus luke Seek, jailctf merger, HETHAT) / others: 76(biz), 76(xsot ovs att joking mewheni), 76(mukundan), 77(intgrah jimboko awu macaque sammyuri), 80(dbdr)
# =================================== 75 ==================================
# R=range(10)
