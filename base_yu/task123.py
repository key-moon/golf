# best: 75(natte, 4atj sisyphus luke Seek mukundan, jailctf merger, intgrah jimboko awu macaque sammyuri, HETHAT) / others: 76(2F), 76(biz), 76(Yuchen20), 76(xsot ovs att joking mewheni), 80(dbdr)
# =================================== 75 ==================================
# R=range(10)
