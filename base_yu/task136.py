# best: 105(jailctf merger, 4atj sisyphus luke Seek mukundan, Code Golf International) / others: 107(jacekw Potatoman nauti natte), 107(ox jam), 107(import itertools), 113(THUNDER THUNDER), 116(biz)
# 131
# def p(g,R=range):
#  for _ in R(10):
#   for i in R(1,9):
