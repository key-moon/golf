# best: 105(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 113(xsot ovs att joking mewheni), 123(Yuchen20), 146(intgrah jimboko awu macaque sammyuri), 147(jacekwl), 147(jacekwl Potatoman nauti)
# 131
# def p(g,R=range):
#  for _ in R(10):
#   for i in R(1,9):
