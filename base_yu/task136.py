# best: 105(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 107(4atj sisyphus luke Seek), 113(xsot ovs att joking mewheni), 122(mukundan), 129(Yuchen20), 146(intgrah jimboko awu macaque sammyuri)
# 131
# def p(g,R=range):
#  for _ in R(10):
#   for i in R(1,9):
