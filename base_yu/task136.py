# best: 105(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 107(ox jam), 116(biz), 120(jacekwl Potatoman nauti), 120(jacekw Potatoman nauti natte), 120(jacekw Potatoman nauti)
# 131
# def p(g,R=range):
#  for _ in R(10):
#   for i in R(1,9):
