# best: 105(4atj sisyphus luke Seek mukundan, jailctf merger) / others: 107(ox jam), 108(jacekw Potatoman nauti natte), 116(biz), 118(intgrah jimboko awu macaque sammyuri), 120(jacekwl Potatoman nauti)
# 131
# def p(g,R=range):
#  for _ in R(10):
#   for i in R(1,9):
