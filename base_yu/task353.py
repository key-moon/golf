# best: 92(Code Golf International, 4atj sisyphus luke Seek mukundan) / others: 93(jailctf merger), 104(ox jam), 111(import itertools), 115(biz), 117(intgrah jimboko awu macaque sammyuri)
# =========================================== 92 ===========================================
