# best: 92(Code Golf International, 4atj sisyphus luke Seek mukundan) / others: 93(jailctf merger), 104(ox jam), 107(HIMAGINE THE FUTURE.), 111(import itertools), 115(biz)
# =========================================== 92 ===========================================
