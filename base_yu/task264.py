# best: 216(xsot ovs att joking mewheni) / others: 222(jailctf merger), 261(4atj sisyphus luke Seek mukundan), 266(4atj sisyphus luke Seek), 268(MasukenSamba), 278(kdmitrie)
def p(g):
#  *o,=eval("[5]*9,"*9)
