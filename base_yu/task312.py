# best: 44(cubbus, 4atj sisyphus luke Seek mukundan, jailctf merger, intgrah jimboko awu macaque sammyuri) / others: 45(natte), 45(ox jam), 45(duckyluuk), 45(JRKX), 45(jacekw Potatoman nauti)
# =================== 44 ===================
