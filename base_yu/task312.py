# best: 44(cubbus, 4atj sisyphus luke Seek mukundan, jailctf merger, intgrah jimboko awu macaque sammyuri) / others: 45(jonas ryno kg583 kabutack), 45(jacekwl Potatoman nauti), 45(JRK), 45(JRKX), 45(jacekwl)
# =================== 44 ===================
