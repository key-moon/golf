# best: 240(jailctf merger) / others: 244(ox jam), 252(intgrah jimboko awu macaque sammyuri), 293(ï¾ï½²ï½½ï½¹ï¾ï½»ï¾ï¾ï¾II), 293(MasukenSamba), 304(Code Golf International)
def p(g):
 c=max(sum(g,[]))
 for _ in range(4):
