# best: 240(jailctf merger) / others: 244(ox jam), 251(intgrah jimboko awu macaque sammyuri), 281(import itertools), 287(HIMAGINE THE FUTURE.), 293(ï¾ï½²ï½½ï½¹ï¾ï½»ï¾ï¾ï¾II)
def p(g):
 c=max(g[0])
 for _ in range(4):
  g[::-1]=zip(*g)
