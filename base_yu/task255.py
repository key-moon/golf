# best: 240(jailctf merger) / others: 244(ox jam), 252(intgrah jimboko awu macaque sammyuri), 293(MasukenSamba), 304(Code Golf International), 304(4atj sisyphus luke Seek mukundan)
def p(g):
 c=max(sum(g,[]))
 for _ in range(4):
