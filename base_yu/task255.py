# best: 243(jailctf merger) / others: 244(xsot ovs att joking mewheni), 297(MasukenSamba), 308(4atj sisyphus luke Seek mukundan), 308(4atj sisyphus luke Seek), 309(duckyluuk)
def p(g):
 c=max(sum(g,[]))
 for _ in range(4):
