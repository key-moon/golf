# best: 94(Code Golf International, 4atj sisyphus luke Seek mukundan, jailctf merger, 2F, biz) / others: 97(ox jam), 117(ï¾ï½²ï½½ï½¹ï¾ï½»ï¾ï¾ï¾II), 120(duckyluuk), 121(THUNDER THUNDER), 123(import itertools)
# ============================================ 94 ============================================
