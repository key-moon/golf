# best: 94(jailctf merger, 2F, 4atj sisyphus luke Seek mukundan, Code Golf International, biz) / others: 97(ox jam), 120(duckyluuk), 121(THUNDER THUNDER), 123(import itertools), 124(MasukenSamba)
# ============================================ 94 ============================================
