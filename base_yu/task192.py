# best: 110(jailctf merger) / others: 115(ox jam), 117(4atj sisyphus luke Seek mukundan), 143(jacekw Potatoman nauti natte), 166(intgrah jimboko awu macaque sammyuri), 193(JRKXK)
