# best: 69(jacekw Potatoman nauti natte, Code Golf International, 4atj sisyphus luke Seek mukundan, natte, import itertools, jailctf merger, ox jam) / others: 73(intgrah jimboko awu macaque sammyuri), 74(jacekwl Potatoman nauti), 74(jacekw Potatoman nauti), 74(THUNDER THUNDER), 75(HIMAGINE THE FUTURE.)
# ================================ 69 ===============================
