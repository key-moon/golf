# best: 268(4atj sisyphus luke Seek mukundan) / others: 289(xsot ovs att joking mewheni), 293(jailctf merger), 303(duckyluuk), 316(MasukenSamba), 351(jonas ryno kg583)
def p(g):
 n=len(g)
 R=range(n*n)
