# best: 67(Code Golf International, 4atj sisyphus luke Seek mukundan, import itertools, jailctf merger, HIMAGINE THE FUTURE.) / others: 75(jacekw Potatoman nauti natte), 75(ox jam), 76(JRKX), 76(kabutack), 76(JRKXK)
