# best: 226(jailctf merger) / others: 235(4atj sisyphus luke Seek mukundan), 242(ox jam), 245(xsot ovs att joking mewheni), 268(jacekw Potatoman nauti), 268(jacekwl Potatoman nauti)
def p(g):
