# best: 226(jailctf merger) / others: 235(4atj sisyphus luke Seek mukundan), 245(xsot ovs att joking mewheni), 268(jacekwl Potatoman nauti), 269(jacekwl), 274(intgrah jimboko awu macaque sammyuri)
def p(g):
