# best: 226(jailctf merger) / others: 235(Code Golf International), 235(4atj sisyphus luke Seek mukundan), 242(ox jam), 248(jacekw Potatoman nauti natte), 248(import itertools)
def p(g):
