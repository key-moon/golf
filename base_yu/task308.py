# best: 226(jailctf merger) / others: 235(4atj sisyphus luke Seek mukundan), 245(ox jam), 245(xsot ovs att joking mewheni), 268(jacekwl Potatoman nauti), 269(jacekwl)
def p(g):
