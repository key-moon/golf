# best: 96(Code Golf International, 4atj sisyphus luke Seek mukundan) / others: 97(jailctf merger), 101(ox jam), 104(HIMAGINE THE FUTURE.), 105(biz), 109(import itertools)
# ============================================= 96 =============================================
