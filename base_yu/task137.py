# best: 141(xsot ovs att joking mewheni) / others: 144(natte), 148(4atj sisyphus luke Seek mukundan), 148(jailctf merger), 148(mukundan), 150(intgrah jimboko awu macaque sammyuri)
# =================================================================== 141 ===================================================================
# def p(g):
#  R=range(len(g))
