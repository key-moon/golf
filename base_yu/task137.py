# best: 141(ox jam, xsot ovs att joking mewheni) / others: 143(jailctf merger), 144(natte), 147(jacekw Potatoman nauti), 147(jacekwl Potatoman nauti), 148(4atj sisyphus luke Seek mukundan)
# =================================================================== 141 ===================================================================
# def p(g):
#  R=range(len(g))
