# best: 122(ox jam, 4atj sisyphus luke Seek mukundan, jailctf merger, xsot ovs att joking mewheni) / others: 135(intgrah jimboko awu macaque sammyuri), 207(jacekwl Potatoman nauti), 239(MasukenSamba), 239(Yuchen20), 256(J&R)
# ========================================================= 122 ==========================================================
def p(g):
 c=max(g)[0]
