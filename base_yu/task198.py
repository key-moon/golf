# best: 122(xsot ovs att joking mewheni, 4atj sisyphus luke Seek mukundan, 4atj sisyphus luke Seek, jailctf merger) / others: 127(mukundan), 239(MasukenSamba), 256(kdmitrie), 256(J&R), 265(Jonas)
# ========================================================= 122 ==========================================================
def p(g):
 c=max(g)[0]
