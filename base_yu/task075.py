# best: 86(jailctf merger, 4atj sisyphus luke Seek mukundan, jacekw Potatoman nauti natte, MasukenSamba, intgrah jimboko awu macaque sammyuri, import itertools) / others: 88(ox jam), 95(jonas ryno kg583), 95(JRKKX), 95(JRKXK), 95(JRKX)
# ======================================== 86 ========================================
