# best: 281(ox jam, xsot ovs att joking mewheni) / others: 312(jailctf merger), 349(4atj sisyphus luke Seek mukundan), 394(Yuchen20), 395(jacekwl Potatoman nauti), 402(MasukenSamba)
def p(g):
