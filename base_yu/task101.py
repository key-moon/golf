# best: 281(xsot ovs att joking mewheni) / others: 315(jailctf merger), 349(4atj sisyphus luke Seek mukundan), 395(jacekwl Potatoman nauti), 396(Yuchen20), 402(MasukenSamba)
def p(g):
 h=len(g)
 w=len(g[0])
 u=[]
