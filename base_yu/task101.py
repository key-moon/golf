# best: 281(ox jam, jailctf merger, xsot ovs att joking mewheni) / others: 321(intgrah jimboko awu macaque sammyuri), 349(4atj sisyphus luke Seek mukundan), 356(natte), 361(kdmitrie), 386(jacekw Potatoman nauti)
def p(g):
