# best: 281(ox jam, xsot ovs att joking mewheni) / others: 312(jailctf merger), 349(4atj sisyphus luke Seek mukundan), 361(kdmitrie), 386(jacekwl Potatoman nauti), 390(Yuchen20)
def p(g):
