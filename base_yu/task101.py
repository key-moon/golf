# best: 281(ox jam, jailctf merger, xsot ovs att joking mewheni) / others: 349(4atj sisyphus luke Seek mukundan), 361(kdmitrie), 386(jacekw Potatoman nauti), 386(jacekwl Potatoman nauti), 390(Yuchen20)
def p(g):
