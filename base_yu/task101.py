# best: 281(ox jam, jailctf merger, xsot ovs att joking mewheni) / others: 349(4atj sisyphus luke Seek mukundan), 356(natte), 361(kdmitrie), 386(jacekw Potatoman nauti), 386(jacekwl Potatoman nauti)
def p(g):
