# best: 93(jailctf merger) / others: 96(Code Golf International), 96(4atj sisyphus luke Seek mukundan), 98(ox jam), 106(import itertools), 113(intgrah jimboko awu macaque sammyuri)
# ============================================ 93 ===========================================
