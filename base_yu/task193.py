# best: 81(jailctf merger) / others: 85(4atj sisyphus luke Seek mukundan), 86(intgrah jimboko awu macaque sammyuri), 87(biz), 97(ox jam), 103(jacekw Potatoman nauti natte)
# ====================================== 81 =====================================
