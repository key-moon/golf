# best: 63(Code Golf International, 4atj sisyphus luke Seek mukundan, jailctf merger, intgrah jimboko awu macaque sammyuri) / others: 64(2F), 64(biz), 70(ox jam), 74(Yuchen20), 78(import itertools)
# ============================= 63 ============================
