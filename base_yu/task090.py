# best: 159(4atj sisyphus luke Seek mukundan, 4atj sisyphus luke Seek) / others: 170(jailctf merger), 188(mukundan), 197(xsot ovs att joking mewheni), 236(MasukenSamba), 237(jonas ryno kg583)
# ============================================================================ 159 ============================================================================
def p(g):
