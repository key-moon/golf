# best: 159(4atj sisyphus luke Seek mukundan) / others: 160(xsot ovs att joking mewheni), 170(jailctf merger), 215(jacekwl Potatoman nauti), 230(Yuchen20), 235(natte)
# ============================================================================ 159 ============================================================================
def p(g):
