# best: 159(4atj sisyphus luke Seek mukundan) / others: 160(xsot ovs att joking mewheni), 170(jailctf merger), 215(jacekwl Potatoman nauti), 235(natte), 236(MasukenSamba)
# ============================================================================ 159 ============================================================================
def p(g):
