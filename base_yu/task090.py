# best: 159(4atj sisyphus luke Seek mukundan) / others: 160(xsot ovs att joking mewheni), 170(jailctf merger), 215(jacekwl Potatoman nauti), 226(Yuchen20), 233(kdmitrie)
# ============================================================================ 159 ============================================================================
def p(g):
