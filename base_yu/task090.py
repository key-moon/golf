# best: 159(Code Golf International, 4atj sisyphus luke Seek mukundan, jailctf merger) / others: 160(ox jam), 182(HIMAGINE THE FUTURE.), 190(import itertools), 195(ï¾ï½²ï½½ï½¹ï¾ï½»ï¾ï¾ï¾II), 205(MasukenSamba)
# ============================================================================ 159 ============================================================================
def p(g):
