# best: 159(4atj sisyphus luke Seek mukundan, Code Golf International) / others: 160(ox jam), 170(jailctf merger), 205(MasukenSamba), 207(jacekw Potatoman nauti natte), 207(import itertools)
# ============================================================================ 159 ============================================================================
def p(g):
