...
# p=lambda g,c=-3:c*g or p([(l:=1)and[[l*s[0]or v,v][l:=l and v!=8]for v in s]for s in zip(*g[::-1])],c+1)
# p=lambda g,c=-3:c*g or p([(l:=1)and[[l*s[0]or v,v][l:=l*(v!=8)]for v in s]for s in zip(*g[::-1])],c+1)
