# best: 67(ox jam, xsot ovs att joking mewheni) / others: 68(4atj sisyphus luke Seek mukundan), 68(jailctf merger), 73(HETHAT), 77(JRKX), 77(jonas ryno kg583 kabutack)
# =============================== 67 ==============================
