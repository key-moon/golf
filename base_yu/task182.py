# best: 169(jailctf merger) / others: 175(4atj sisyphus luke Seek mukundan), 187(xsot ovs att joking mewheni), 234(jacekwl Potatoman nauti), 235(Potatoman), 235(intgrah jimboko awu macaque sammyuri)
# ================================================================================= 169 =================================================================================
def p(g):
 for l in range(14):
  for u in range(14):
