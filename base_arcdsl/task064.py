...
def p(I):
    ...
    x4 = val_func_toindices(x3)
    x5 = val_func_ofcolor(I, x1)
    x6 = val_func_prapply(val_func_connect, x4, x5)
    x7 = val_func_fork(val_func_either, val_func_vline, val_func_hline)
    x8 = val_func_mfilter(x6, x7)
