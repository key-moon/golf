...
def p(I):
    ...
    x5 = val_func_subgrid(x3, I)
    x6 = val_func_width(x4)
    x7 = val_func_width(x5)
    x8 = val_func_divide(x6, x7)
    x9 = val_func_downscale(x4, x8)
    x10 = val_func_ofcolor(x9, 0)
    O = val_func_fill(x5, 0, x10)
    return [*map(list,O)]
