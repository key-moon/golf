...
def p(I):
    ...
    x4 = val_func_astuple(x3, x2)
    x5 = val_func_crop(I, (0, 0), x4)
    x6 = val_func_hmirror(x5)
    x7 = val_func_vconcat(I, x6)
    x8 = val_func_double(x3)
    x9 = val_func_astuple(x8, x2)
    x10 = val_func_crop(x7, (1, 0), x9)
    O = val_func_vconcat(x7, x10)
    return [*map(list,O)]
