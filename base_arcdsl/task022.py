...
def p(I):
    ...
    x2 = val_func_matcher(val_func_first, 5)
    x3 = val_func_rbind(val_func_sfilter, x2)
    x4 = val_func_chain(val_func_invert, val_func_center, x3)
    x5 = val_func_fork(val_func_shift, val_func_identity, x4)
    x6 = val_func_canvas(0, (3, 3))
    x7 = mval_func_apply(x5, x1)
    x8 = val_func_shift(x7, (1, 1))
    O = val_func_paint(x6, x8)
    return [*map(list,O)]
