...
def p(I):
    ...
    x4 = val_func_fork(val_func_vmatching, val_func_first, val_func_last)
    x5 = val_func_fork(val_func_hmatching, val_func_first, val_func_last)
    x6 = val_func_fork(val_func_either, x4, x5)
    x7 = val_func_sfilter(x3, x6)
    x8 = val_func_compose(val_func_center, val_func_first)
    x9 = val_func_compose(val_func_center, val_func_last)
    x10 = val_func_fork(val_func_connect, x8, x9)
    x11 = val_func_chain(val_func_initset, val_func_center, x10)
    x12 = val_func_compose(val_func_color, val_func_first)
    x13 = val_func_fork(val_func_reval_func_color, x12, x11)
    x14 = mval_func_apply(x13, x7)
