...
def p(I):
    ...
    x3 = val_func_rbind(val_func_greater, 2)
    x4 = val_func_compose(x3, val_func_size)
    x5 = val_func_sfilter(x2, x4)
    x6 = val_func_totuple(x5)
    x7 = val_func_apply(val_func_color, x6)
    x8 = val_func_apply(val_func_center, x6)
    x9 = val_func_pair(x7, x8)
    x10 = val_func_fill(I, 0, x1)
    x11 = val_func_paint(x10, x9)
    x12 = val_func_rbind(val_func_greater, 1)
    x13 = val_func_compose(val_func_dedupe, val_func_totuple)
    x14 = val_func_chain(x12, val_func_size, x13)
    x15 = val_func_sfilter(x11, x14)
    x16 = val_func_rot90(x15)
    x17 = val_func_sfilter(x16, x14)
    O = val_func_rot270(x17)
    return [*map(list,O)]
