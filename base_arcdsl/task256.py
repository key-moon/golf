...
def p(I):
    ...
    x2 = val_func_urcorner(x1)
    x3 = val_func_shoot(x2, (-1, 1))
    x4 = val_func_shoot(x2, (1, -1))
    x5 = val_func_underfill(I, 3, x3)
    x6 = val_func_underfill(x5, 1, x4)
    x7 = val_func_rbind(val_func_shoot, (0, -1))
    x8 = mval_func_apply(x7, x3)
    x9 = mval_func_apply(x7, x4)
    x10 = val_func_underfill(x6, 1, x9)
    O = val_func_underfill(x10, 3, x8)
    return [*map(list,O)]
