...
def p(I):
    ...
    x3 = val_func_replace(I, x1, 3)
    x4 = val_func_argmax(x2, val_func_size)
    x5 = val_func_argmin(x2, val_func_size)
    x6 = val_func_position(x4, x5)
    x7 = val_func_first(x6)
    x8 = val_func_last(x6)
    x9 = val_func_subgrid(x4, x3)
    x10 = val_func_hline(x5)
    x11 = val_func_hmirror(x9)
    x12 = val_func_vmirror(x9)
    x13 = val_func_branch(x10, x11, x12)
    x14 = val_func_branch(x10, x7, 0)
    x15 = val_func_branch(x10, 0, x8)
    x16 = val_func_asobject(x13)
    x17 = val_func_matcher(val_func_first, 3)
    x18 = val_func_compose(val_func_flip, x17)
    x19 = val_func_sfilter(x16, x18)
    x20 = val_func_ulcorner(x4)
    x21 = val_func_shape(x4)
    x22 = val_func_astuple(x14, x15)
    x23 = val_func_multiply(x21, x22)
    x24 = val_func_add(x20, x23)
    x25 = val_func_shift(x19, x24)
    O = val_func_paint(x3, x25)
    return [*map(list,O)]
