...
def p(I):
    ...
    x4 = val_func_vmirror(x2)
    x5 = val_func_dmirror(x2)
    x6 = val_func_cmirror(x2)
    x7 = val_func_paint(I, x3)
    x8 = val_func_paint(x7, x4)
    x9 = val_func_paint(x8, x5)
    O = val_func_paint(x9, x6)
    return [*map(list,O)]
