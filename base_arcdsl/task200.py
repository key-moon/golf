...
def p(I):
    ...
    x5 = val_func_leftmost(x3)
    x6 = val_func_interval(x5, 10, 2)
    x7 = val_func_rbind(val_func_contained, x6)
    x8 = val_func_compose(x7, val_func_last)
    x9 = val_func_sfilter(x1, x8)
    x10 = val_func_increment(x5)
    x11 = val_func_add(x5, 3)
    x12 = val_func_interval(x10, 10, 4)
    x13 = val_func_interval(x11, 10, 4)
    x14 = val_func_lbind(val_func_astuple, 9)
    x15 = val_func_apply(val_func_tojvec, x12)
    x16 = val_func_apply(x14, x13)
    x17 = val_func_fill(I, x4, x9)
    x18 = val_func_fill(x17, 5, x15)
    O = val_func_fill(x18, 5, x16)
    return [*map(list,O)]
