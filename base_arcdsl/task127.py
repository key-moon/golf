...
def p(I):
    ...
    x3 = val_func_compose(val_func_neighbors, val_func_center)
    x4 = val_func_fork(val_func_reval_func_color, val_func_color, x3)
    x5 = mval_func_apply(x4, x2)
    x6 = val_func_paint(I, x5)
    x7 = val_func_replace(x6, 1, 6)
    x8 = val_func_replace(x7, 2, 7)
    x9 = val_func_replace(x8, 3, 8)
    O = val_func_replace(x9, 4, 9)
    return [*map(list,O)]
