...
def p(I):
    ...
    x2 = val_func_colorfilter(x1, 9)
    x3 = val_func_colorfilter(x1, 1)
    x4 = val_func_rbind(val_func_bordering, I)
    x5 = val_func_compose(val_func_flip, x4)
    x6 = val_func_mfilter(x2, x5)
    x7 = val_func_rbind(val_func_adjacent, x6)
    x8 = val_func_mfilter(x3, x7)
    O = val_func_fill(I, 8, x8)
    return [*map(list,O)]
