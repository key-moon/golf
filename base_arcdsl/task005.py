...
def p(I):
    ...
    x5 = val_func_lbind(mval_func_apply, x4)
    x6 = val_func_double(10)
    x7 = val_func_interval(4, x6, 4)
    x8 = val_func_rbind(val_func_apply, x7)
    x9 = val_func_lbind(val_func_position, x2)
