...
def p(I):
    ...
    x3 = val_func_compose(val_func_last, val_func_center)
    x4 = val_func_order(x2, x3)
    x5 = val_func_size(x4)
    x6 = val_func_interval(0, x5, 3)
    x7 = val_func_rbind(val_func_contained, x6)
    x8 = val_func_compose(x7, val_func_last)
    x9 = val_func_interval(0, x5, 1)
    x10 = val_func_pair(x4, x9)
    x11 = val_func_sfilter(x10, x8)
    x12 = mval_func_apply(val_func_first, x11)
