# best: 281(jailctf merger, ox jam) / others: 349(4atj sisyphus luke Seek mukundan), 353(jacekw Potatoman nauti natte), 354(natte), 361(kdmitrie), 386(jacekwl Potatoman nauti)
def p(g):
