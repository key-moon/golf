# best: 269(jailctf merger, ox jam) / others: 281(intgrah jimboko awu macaque sammyuri), 322(4atj sisyphus luke Seek mukundan), 325(open source), 325(jacekwl Potatoman nauti), 325(jacekw Potatoman nauti natte)
def p(g):
